            ...
            text = {
                Text(
                    text = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
                        "OBDPlus needs Nearby Devices (Bluetooth) permission to connect to your OBD-II adapter. " +
                            "Please grant it in the app's system settings."
                    } else {
                        "OBDPlus needs Location permission to scan for Bluetooth devices on this Android version. " +
                            "Please grant it in the app's system settings."
                    },
                    color = TextSecondary,
                )
