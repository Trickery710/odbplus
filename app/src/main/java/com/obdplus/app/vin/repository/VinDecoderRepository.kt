package com.obdplus.app.vin.repository
...
import com.obdplus.app.vin.cache.VinCachePolicy
import com.obdplus.app.vin.domain.DecodedVin
import com.obdplus.app.vin.domain.DecodeSource
import com.obdplus.app.vin.domain.VinDecodeOutcome
import com.obdplus.app.vin.domain.VinValidationResult
import com.obdplus.app.vin.domain.VinValidationStatus
import com.obdplus.app.vin.domain.VerificationStatus
import com.obdplus.app.vin.network.NetworkDecodeResult
import com.obdplus.app.vin.network.VinDecoderService
import com.obdplus.app.vin.validation.VinValidator
import com.obdplus.app.vin.verification.VinVerificationEngine
...
class VinDecoderRepository @Inject constructor(
    ...
    private suspend fun handleNetworkResult(
        ...
        cachedIdentity: com.obdplus.app.data.db.entity.VehicleIdentityEntity?
    ): VinDecodeOutcome {
