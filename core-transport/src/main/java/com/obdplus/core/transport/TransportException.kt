...
/**
 * Thrown when a required runtime permission (e.g. BLUETOOTH_CONNECT on API 31+)
 * has been revoked while the connection was active or before it was established.
 */
